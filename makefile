...
COMPONENT_FILES	:= controller.sv shaComputationalBlock.sv compressionSHA.sv extensionSHA.sv counter.sv preprocessor.sv comparator.sv nonceGenerator.sv risingEdgeDetect.sv my_slave.sv
